    ...
    return [
        ...
        Node(
            ...
            parameters=[{
                ...
                'SuperPoint/ModelPath': '/home/alice/rtabmap_ws/src/superpoint_v1.pt',
                'PyMatcher/Path': '/home/alice/rtabmap_ws/src/SuperGluePretrainedNetwork/rtabmap_superglue.py',
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('frame_id',       default_value='zed_camera_link',          description='zed_camera_link  tracker'),
