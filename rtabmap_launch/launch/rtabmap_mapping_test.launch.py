...
def launch_setup(context, *args, **kwargs):      
    ...
    return [
        ...
        #     condition=IfCondition(PythonExpression(["'", LaunchConfiguration('stereo'), "' == 'true' and '", LaunchConfiguration('rgbd_sync'), "' == 'false'"])),
        #     parameters=[{
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('frame_id',       default_value='tracker_link',          description='zed_camera_link  tracker'),
        ...
        DeclareLaunchArgument('wait_for_transform', default_value='1.0',            description='0.2'),
        ...
        DeclareLaunchArgument('odom_topic',                 default_value='/aeirobot/tracker/odometry',  description='Odometry topic name., /zed_odom '),
