    ...
    return [
        ...
        Node(
            ...
            parameters=[{
                ...
                'RGBD/ForceOdom3DoF': 'false',      # VO 추정 z/roll/pitch 를 0으로 강제 => 기본값은 true
                ...
                'SuperPoint/Threshold': '0.010'    # 기본값 0.010
            }],
            remappings=[
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('database_path',  default_value='~/.ros/mapping/test.db',  description='Where is the map saved/loaded.'),
